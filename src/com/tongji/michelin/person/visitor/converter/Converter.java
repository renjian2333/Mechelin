...
public abstract class Converter<T, E> {
    ...
    /**
     * @param fromDto    converts given dto entity into the domain entity.
     * @param fromEntity Function that converts entity to the dto entity.
     */
     ...
     * @return the result of the converting function application on dto entity.
     */
     ...
     * @return the result of the converting function application on domain entity.
     */
     ...
     * @return List of entities converted from collection of DTO entities
     */
     ...
     * @return List of DTO entities converted from collection of entities
     */
